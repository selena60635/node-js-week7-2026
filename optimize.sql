...
-- 工單 2：企業會員的課表
CREATE INDEX IF NOT EXISTS idx_course_bookings_user_id_cancelled_at ON course_bookings(user_id, cancelled_at);
...
CREATE INDEX IF NOT EXISTS idx_course_bookings_user_id_not_cancelled ON course_bookings(user_id) WHERE cancelled_at IS NULL;
